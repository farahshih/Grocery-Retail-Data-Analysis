...
The file Summary.md summarizes graphs and models we built to predict sales of frozen juice. A detailed step-by-step data analysis is described in the file Modelling_AggSales.md. All functions we designed on our own is listed in the file  Func_AggSales.md   
